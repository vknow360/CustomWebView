...
public final class CustomWebView extends AndroidNonvisibleComponent implements ActivityResultListener{
    ...
    public boolean BlockNetworkLoads = true;
    ...
    webView.addJavascriptInterface(wvInterface, "AppInventor");
        ...
        webView.getSettings().setBlockNetworkImage(BlockNetworkLoads);
  ...
  public void WebviewArrangement(HVArrangement view){
      View v = view.getView();
          FrameLayout frameLayout = (FrameLayout) v;
        resetWebViewClient();
        frameLayout.addView(webView);
        FrameLayout.LayoutParams  param = new FrameLayout.LayoutParams(new FrameLayout.LayoutParams(-1,-1));
